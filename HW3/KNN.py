class KNN:
    def __init__(self, size, testsize):
        from sklearn.neighbors import KNeighborsClassifier
        self.classifier = KNeighborsClassifier(size, weights="uniform")
    ...
    def run(self, digits, data):
        ...
        x_train, x_test, y_train, y_test = \
            train_test_split(data,digits.target, test_size=self.testsize, random_state=52, shuffle=False)
